    ...
    def plot_time_to_target(
        ...
        *,
        ...
        if successful_times:
            ...
            ax_percentage.plot(
                ordered_times, cumulative_percentage, marker="o", color="forestgreen"
            )
            ax_percentage.axhline(
        ...
        ax_counts.set_xlabel("Time to target (s)")
        ax_counts.set_ylabel("Runs reaching target")
        ...
        ax_percentage.set_xlabel("Time to target (s)")
        ax_percentage.set_ylabel("Runs reaching target (%)")
        ax_percentage.set_ylim(bottom=0, top=100)
